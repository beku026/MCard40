...
namespace MCard40.Web.Areas.Identity.Pages.Account.Manage
{
    public class EmailModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [EmailAddress]
            [Display(Name = "Новое электронное письмо")]
            public string NewEmail { get; set; }
        }

        private async Task LoadAsync(MCardUser user)
        {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                StatusMessage = "Ссылка для подтверждения изменения отправленного электронного письма. Пожалуйста, проверьте свою электронную почту.";
