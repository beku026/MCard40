...
namespace MCard40.Web.Areas.Identity.Pages.Account.Manage
{
    public class ExternalLoginsModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            if (_userStore is IUserPasswordStore<MCardUser> userPasswordStore)
            {
        ...
        public async Task<IActionResult> OnGetLinkLoginCallbackAsync()
        {
            ...
            if (info == null)
            {
                throw new InvalidOperationException($"Произошла непредвиденная ошибка при загрузке внешней информации для входа.");
            }
