...
namespace MCard40.Web.Areas.Identity.Pages.Account.Manage
{
    public class GenerateRecoveryCodesModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            {
                throw new InvalidOperationException($"Не удается сгенерировать коды восстановления для пользователя, поскольку у них не включен 2FA.");
            }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!isTwoFactorEnabled)
            {
                throw new InvalidOperationException($"Не удается сгенерировать коды восстановления для пользователя, так как у них не включен 2FA.");
            }
